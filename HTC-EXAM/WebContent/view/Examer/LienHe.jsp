...
<div class="container-fluid bg-1 text-center">
  <h3 class="margin">Our Fanpage (FaceBook)</h3>
  <img src="library/images/fb.jpg" class="img-responsive img-circle margin" style="display:inline" alt="Bird" width="350" height="350">
  <h3>HTC-Exams Fanpage</h3>
</div>

<!-- Second Container -->
<div class="container-fluid bg-2 text-center">
  <h3 class="margin">Can I Help You ?</h3>
  <p>Đây là Fanpage chính thức của HTC-Exams. Đây là nơi cập nhật một số tin tức sớm nhất về các vấn đề có liên quan đến HTC-Exams như: Lịch thi, Điểm Thi... </p>
  <p>--------------------------------</p>
  <a href="#" class="btn btn-default btn-lg">
    <span class="glyphicon glyphicon-home"></span> Go To Our-Fanpage
  </a>
</div>

<!-- Third Container (Grid) -->
<div class="container-fluid bg-3 text-center">    
  <h2 class="margin" style="color : red">Liên Hệ Khác</h2><br>
  <div class="row">
    <div class="col-sm-4">
      <p>Bạn có thể gọi trực tiếp qua hotline: 01628841051 để được trợ giúp</p>
      <img src="library/images/nhanvien1.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-4"> 
      <p>Liên hệ trực tiếp qua skype: 01628841051</p>
      <img src="library/images/skype.png" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-4"> 
      <p> Hoặc liên hệ qua mail: htcexams@gmail.com</p>
      <img src="library/images/gmail.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
  </div>
</div>
