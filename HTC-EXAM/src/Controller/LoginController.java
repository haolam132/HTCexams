...
public class LoginController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("view/Examer/Login.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (roleid) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("view/Admin/tamthoi.jsp");
				rd.forward(request, response);
				return;
			...
			if (quesiton) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("view/Question/trang xem danh sach cau hoi.jsp");
				rd.forward(request, response);
				return;
			...
			if (exammanager) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("view/Exam/trang xem toan bo de thi.jsp");
				rd.forward(request, response);
				return;
			}
