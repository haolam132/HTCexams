...
public class ManageExamDAO {
	...
	// Insert One tsount LiÃªn káº¿t vá»›i servlet Inserttsount
		public static boolean CreateTestSheet(TestSheet ts) {
			...
			try {
				...
				// Khá»Ÿi táº¡o vÃ  gá»�i cÃ¢u truy váº¥n Ä‘áº¿n store
				CallableStatement ptmt = conn.prepareCall("{call pr_CreateTest(? ,? ,? ,? ,? ,? ,? ,? )}");
				 
				// Set cÃ¡c giÃ¡ trá»‹ cho cÃ¢u truy váº¥n
				...
				// CÃ¢u lá»‡nh thá»±c hiá»‡n cÃ¢u truy váº¥n
		...
		public static List<Exam> ShowListExam(int start, int end) {
			...
			// Khá»Ÿi táº¡o má»™t 1 list lÆ°u trá»¯ cÃ¡c dá»¯ liá»‡u
